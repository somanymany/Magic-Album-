...
Page({
  data: {
    imgUrls: [
      'https://zhenz-1309499835.cos.ap-beijing.myqcloud.com/hbws%2Fimages%2F4-1.jpg',
      'https://zhenz-1309499835.cos.ap-beijing.myqcloud.com/hbws%2Fimages%2F4-2.jpg',
      'https://zhenz-1309499835.cos.ap-beijing.myqcloud.com/hbws%2Fimages%2F4-3.jpg'
    ],
    ...
    wx.chooseMedia({
      ...
      success(res) {
        ...
        wx.uploadFile({
          filePath: img_src,
          name: 'myImage',
          url: 'http://124.222.26.209:8000/api/Animation_Magic/',
          method:'POST',
          header:{
